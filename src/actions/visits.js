...
export const CREATE_VISIT_SUCCESS: 'CREATE_VISIT_SUCCESS' = 'CREATE_VISIT_SUCCESS';
export const CREATE_VISIT_FAILURE: 'CREATE_VISIT_FAILURE' = 'CREATE_VISIT_FAILURE';
export const RESET_NEW_VISIT: 'RESET_NEW_VISIT' = 'RESET_NEW_VISIT';

//Fetch visits
export const FETCH_VISITS: 'FETCH_VISITS' = 'FETCH_VISITS';
export const FETCH_VISITS_SUCCESS: 'FETCH_VISITS_SUCCESS' = 'FETCH_VISITS_SUCCESS';
export const FETCH_VISITS_FAILURE: 'FETCH_VISITS_FAILURE' = 'FETCH_VISITS_FAILURE';
export const RESET_VISITS: 'RESET_VISITS' = 'RESET_VISITS';

//Update visit
export const UPDATE_VISIT: 'UPDATE_VISIT' = 'UPDATE_VISIT';
export const UPDATE_VISIT_SUCCESS: 'UPDATE_VISIT_SUCCESS' = 'UPDATE_VISIT_SUCCESS';
export const UPDATE_VISIT_FAILURE: 'UPDATE_VISIT_FAILURE' = 'UPDATE_VISIT_FAILURE';
...
export const createVisit = (business: Business, visit: Visit, token: string) => {
  return (dispatch: Dispatch) => {
...
export const updateVisitSuccess = (payload: Visit): UpdateVisitSuccessAction => {
  return {
